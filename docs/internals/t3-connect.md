...
T3CODE_PORT=13773 \
  "/Applications/ML Code (Alpha).app/Contents/MacOS/ML Code (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/ML Code (Alpha).app"
codesign -d --entitlements :- "/Applications/ML Code (Alpha).app"
```
