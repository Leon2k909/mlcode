...
/** What update path a client should offer for a server: one of the RPC
    ...
    version belongs to the ML Code desktop app supervising it — updating the
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands thread.copy. Same version-skew contract as
      threadSettlement. */
  threadCopy: Schema.optionalKey(Schema.Boolean),
