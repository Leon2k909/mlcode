...
/** How a follow-up should be delivered while a provider turn is running. */
export const ThreadTurnDispatchMode = Schema.Literals(["steer", "queue"]);
...
export const OrchestrationProject = Schema.Struct({
  ...
  // "no override": clients fall back to ml.json, then the global setting.
...
const ThreadMessageDeleteCommand = Schema.Struct({
  type: Schema.Literal("thread.message.delete"),
  commandId: CommandId,
  threadId: ThreadId,
  messageId: MessageId,
  createdAt: IsoDateTime,
...
export const ThreadMessageDeletedPayload = Schema.Struct({
  threadId: ThreadId,
  messageId: MessageId,
  deletedAt: IsoDateTime,
});
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.message-deleted"),
    payload: ThreadMessageDeletedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
