      ...
      [
        ...
        environment(
          ...
          summary(
            ...
            // Below the compatibility floor, which is what makes it stale.
            // Writing this as an offset from the current version only worked
            // while the window happened to be two wide.
