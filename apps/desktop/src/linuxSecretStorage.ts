...
function getGnomeKeyringRemediationMessage(): string {
  return "ML Code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart ML Code.";
}

function getKWalletRemediationMessage(): string {
  return "ML Code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart ML Code.";
}
