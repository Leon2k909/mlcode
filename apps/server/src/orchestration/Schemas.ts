import {
  ...
  ThreadMessageDeletedPayload as ContractsThreadMessageDeletedPayloadSchema,
...
export const ThreadMessageDeletedPayload = ContractsThreadMessageDeletedPayloadSchema;
