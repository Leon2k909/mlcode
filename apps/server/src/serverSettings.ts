...
const make = Effect.gen(function* () {
  ...
  const loadSettingsFromDisk = Effect.gen(function* () {
    ...
    // Employee normalization is this fork's, and has to run on the settings
    // upstream's provider restore hands back rather than on the raw decode.
    return normalizeServerSettingsEmployees(
