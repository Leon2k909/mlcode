...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerRealtimeStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerRealtimeAppendAudio]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerRealtimeAppendText]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerRealtimeAppendSpeech]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerRealtimeStop]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeProviderRealtime]: AuthOrchestrationReadScope,
