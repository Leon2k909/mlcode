        ...
        .map<RawThreadFeedEntry>((entry) => {
          ...
          return {
            ...
            activity: {
              ...
              // NOTE: fork field read as entry.sourceActivityKind (was
              // entry.activityKind pre-merge; the entry type now names it
              // sourceActivityKind). Feeds deriveStoppedEmployeeHandoffs.
              sourceActivityKind: entry.sourceActivityKind,
