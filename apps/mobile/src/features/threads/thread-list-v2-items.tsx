...
export const ThreadListV2Row = memo(function ThreadListV2Row(props: {
  ...
  // NOTE: dropped fork prop `onChangeRequestState` here — it referenced type
  // `ThreadListV2ChangeRequestState` (defined nowhere in the repo) with no
  // caller/consumer. Upstream superseded client-driven auto-settle with the
  // server-settings AutoSettleSettingsRows flow, so this orphan is obsolete.
