    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active ML Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow ML Code to connect to ML Code servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow ML Code to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow ML Code to access your camera so you can scan pairing QR codes.",
