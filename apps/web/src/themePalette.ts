...
/**
 * The palette ML Code wears with no theme installed, captured from the app's
...
/**
 * The standard ML Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors ML Code shows without a theme, read from the app's own
