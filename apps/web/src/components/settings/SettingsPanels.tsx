  ...
  return (
    <>
      ...
      {hasDesktopBridge ? (
        <SettingsRow
          title="Update track"
          // NOTE: This fork ships Nightly-only (Stable is disabled), so we keep our
          // static Nightly indicator rather than upstream's Stable/Nightly channel
          // selector. Upstream's selector also depends on selectedUpdateChannel /
          // handleUpdateChannelChange / DesktopUpdateChannel, which this fork's panel
          // does not define — adopting it here would not compile.
          description="ML Code currently ships rolling Nightly desktop releases."
          control={<span className="text-sm font-medium">Nightly</span>}
        />
