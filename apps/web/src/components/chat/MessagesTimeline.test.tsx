...
describe("MessagesTimeline", () => {
  ...
  it("uses each assistant row's persisted selection instead of the latest thread selection", () => {
    ...
    expect(markup).toContain('aria-label="Riley uses gpt-5.6-luna via Codex at Low reasoning"');
  ...
  it("shows Claude effort levels in employee attribution", () => {
    ...
    expect(markup).toContain('aria-label="Alex uses claude-opus-5 via Claude at Max reasoning"');
  });
