...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "thread-to-side";
}
...
export type CommandPaletteUiAction =
  ...
  | { readonly _tag: "OpenThreadToSide" }
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenThreadToSide":
      return { open: true, mode: "command", openIntent: { kind: "thread-to-side" } };
