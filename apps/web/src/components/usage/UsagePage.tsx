                ...
                <div key={`${snapshot.provider}:${window.label}`} className="flex flex-col gap-2">
                  <div className="flex items-start justify-between gap-4">
                    <span className="flex items-center gap-2 text-sm text-foreground">
                      ...
                      {PROVIDER_PRESENTATION[snapshot.provider].label} {window.label}
                  ...
                  {used === null ? (
                    ...
                    <>
                      <div
                        ...
                        role="progressbar"
                        aria-label={`${PROVIDER_PRESENTATION[snapshot.provider].label} ${window.label} usage`}
                        aria-valuemin={0}
                        aria-valuemax={100}
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${used}%`,
                            backgroundColor: PROVIDER_PRESENTATION[snapshot.provider].color,
                          }}
                        />
                      </div>
