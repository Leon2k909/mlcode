...
export function WorkspacePageHeader({
  ...
  /**
   * Whether this header sits behind the floating sidebar toggle that appears
   * when the sidebar collapses. Only the leftmost pane does; the rest would
   * indent their breadcrumb for a control nowhere near them.
   */
  readonly reserveSidebarToggle?: boolean;
}) {
  return (
    <header
      className={cn(
        ...
        reserveSidebarToggle && COLLAPSED_SIDEBAR_TITLEBAR_INSET_CLASS,
        className,
      )}
      {...props}
    />
