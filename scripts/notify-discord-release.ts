  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new ML Code prerelease is available for nightly testers."
          : "A new ML Code latest release is available.",
...
).pipe(Command.withDescription("Post a ML Code release announcement to Discord."));
