export const BRAND_ASSET_PATHS = {
  ...
  productionWindowsIconIco: "assets/ml-code/ml-code-windows.ico",
  productionWebFaviconIco: "assets/ml-code/ml-code-web-favicon.ico",
  productionWebFavicon16Png: "assets/ml-code/ml-code-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/ml-code/ml-code-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/ml-code/ml-code-web-apple-touch-180.png",
  ...
  nightlyWindowsIconIco: "assets/ml-code/ml-code-windows.ico",
  nightlyWebFaviconIco: "assets/ml-code/ml-code-web-favicon.ico",
  nightlyWebFavicon16Png: "assets/ml-code/ml-code-web-favicon-16x16.png",
  nightlyWebFavicon32Png: "assets/ml-code/ml-code-web-favicon-32x32.png",
  nightlyWebAppleTouchIconPng: "assets/ml-code/ml-code-web-apple-touch-180.png",

  developmentDesktopIconPng: "assets/ml-code/ml-code-app-icon-1024.png",
  developmentWindowsIconIco: "assets/ml-code/ml-code-windows.ico",
  developmentWebFaviconIco: "assets/ml-code/ml-code-web-favicon.ico",
  developmentWebFavicon16Png: "assets/ml-code/ml-code-web-favicon-16x16.png",
  developmentWebFavicon32Png: "assets/ml-code/ml-code-web-favicon-32x32.png",
  developmentWebAppleTouchIconPng: "assets/ml-code/ml-code-web-apple-touch-180.png",
} as const;
